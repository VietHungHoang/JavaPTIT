...
class PhoneCall implements Comparable<PhoneCall>{
    ...
    public int compareTo(PhoneCall p){
        return -(this.totalTime * this.price - p.totalTime * p.price);
    }
}
...
public class J05072_TinhCuocDienThoaiCoDinh2 {
    public static void main(String[] args) {
        ...
        Arrays.sort(arr);
        for(PhoneCall x : arr) System.out.println(x);
